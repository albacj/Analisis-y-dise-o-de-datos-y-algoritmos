...
/**
 * <p> Un cromosoma mixto formado por uno binario y otro de tipo clave aleatoria.
 * Es un cromosoma adecuado para codifica problemas de permutaciones de subconjuntos de multiconjuntos</p>
 * 
 * @author Miguel Toro
 *
 */
public class BagMixChromosome extends Chromosome implements BagChromosome {
	...
	public List<Integer> decode() {	
		...
		List<Integer> rk = randomKey.decode(secNormal);
	...
	public List<Integer> getNormalSequence() {
		return AlgoritmoAGMix.normalSequence;
	}
