...
public class AlgoritmoSA<E extends EstadoSA<E,S,A>,S,A> extends AbstractAlgoritmo {
    ...
    /**
     * N�mero de intentos. En cada intento se parte del estado incial y se llevan a cabo
     * un n�mero de iteraciones por intento. En cada iteraci�n se llevan a cabo un n�mero de iteraciones 
	...
	/**
	 * 
	 * <p> La temperatura disminuye en ese factor en cada iteraci�n: t = &alpha;&#42;t. Por lo que t = t0&#42;&alpha; &#94; i. </p>
	 * <p> El n�mero total de iteraciones es m&#42;n.  Este n�mero es una medida del tiempo de ejecuci�n del algoritmo. </p>
	 * <p> La probabilidad p de aceptar un cambio de estado de tama�o &Delta; depende de la temperatura en la forma 
	 ...
	 * Un caso t�pico  &alpha; = 0.97, n = 200, pf = 0.01 
	 * </p>
	 * 
